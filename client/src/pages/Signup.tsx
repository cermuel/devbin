...
const Signup = () => {
  ...
  return (
    <main className="w-screen bg-black h-screen flex flex-row-reverse items-center">
      <section className="w-[65%] max-md:hidden h-full">
        <img src={gif} className="w-full h-full" alt="" />
      </section>
      <section className="w-[35%] relative max-md:w-full h-full py-12 flex justify-between items-center flex-col">
        <Toaster /> <img src={longlogo} className="w-[40%]" alt="" />
